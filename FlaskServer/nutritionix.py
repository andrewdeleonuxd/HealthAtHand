...
class NutritionixClient:
    ...
    def natural(self, **kwargs):
        ...
        return self.execute(endpoint, method="POST", params=params, data=data, headers={'Content-Type': 'application/json'})
    
    def exercise(self, **kwargs):
        """
        Supports natural exercise points like 1 ran 10 miles.
        """
    ...
    def search(self, **kwargs):  # TODO: Add advance search filters
        ...
        #endpoint = urlparse.urljoin(BASE_URL, phrase)
